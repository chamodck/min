<div class="row">
      <div class="col s12 m3 blue lighten-4" style="height:550px">
        ...
        <div class="col s12 "><h5>Search Users</h5></div>
      ...
      <div class="col s12 m9">
        ...
        <tbody>
          <tr ng-repeat="user in users | filter:paginate| filter:search">
            ...
            <td>
              <a class="btn-floating waves-effect waves-light" title="Edit" ng-click="edit(user.id)"><i class="material-icons">mode_edit</i></a>
            </td>
          </tr>
        </tbody>
      </table>
